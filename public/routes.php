...
switch($url[0]) {
    ...
    default:
        ...
        $ctrlPath = DIR_ROOT . 'Controllers/' . $ucFirstreqCtrllr . 'Controller.php';
        $mdlPath = DIR_ROOT . 'Models/' . $ucFirstreqCtrllr . 'Model.php';
        ...
        $modelName      = 'Models\\' . $ucFirstreqCtrllr . 'Model';
        $controllerName = 'Controllers\\'. $ucFirstreqCtrllr . 'Controller';
